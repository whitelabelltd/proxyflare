...
class IP {
	 ...
	 * @param $ip is the IPV6 address in decimal format to check if its within the IP range created by the cloudflare IPV6 address, $range_ip.
	 * @param $range_ip converted to full IPV6 format.
	 *
